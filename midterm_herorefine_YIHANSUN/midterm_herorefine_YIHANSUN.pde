...
void draw() {
  ...
  ///
    ...
    text("Click Magic Pill", width/2+220, height/2+230);
    noFill();
    imageMode(CORNER);
    ...
    image(img1,490,460,300,300); 
     ...
     ellipse(width/2+220, height/2+150, 80*sin(a), 80*sin(a));
     noFill();
     circles();
     stroke(255,y3,255);
     strokeWeight(3); 
...
////hero
  ...
  //trick
    ...
    textSize(45);
    textAlign(CENTER);
    text("Please try again,he requires prepare time", width/2, height/2);
  }
   ...
   else if (state=="trick3") {
    background(255);
    textSize(50);
    textAlign(CENTER);
    text("Sorry,you have no choice", width/2, height/2);
  }
  /////scence
   else if (state=="S1") {
    background(0);
    textSize(40);
    fill(255);
    text("A lovely story will happen here",350,80);
    //rect(width/2-450,300,300,50);
    //rect(width/2+250,300,300,50);
    //fill(0);
    textSize(20);
    text("Right-click to choose your girl ",width/2-400,655);
    text("Left-click to choose again",width/2+360,655);
    
    imageMode(CENTER);
    image(images[imageIndex],width/2,height/2+20);
  ...
  println(imageIndex);
    ...
    game();
    image(imgh1,mouseX-10,mouseY-10,200,200);
    if(counter>5&&score>=30&&score<60){
       gameE1();
  }
    else if(counter>5&&score>=60&&score<90){ 
        gameE2();
      }
    else if(counter>5&&score>=90){ 
        gameHh1();
      }
...
void mousePressed() {
  ...
  ////
    ...
    else if(mouseX>0 && mouseX<1280 && mouseY>50 && mouseY<400){
    state="trick3";
    }
  } 
  ////
...
//////
  ...
  if (gameState == 1) {
    ...
    text(score,200, 300);
    textSize(30);
    text("Three ending are waiting for you", 250, 150);
    textSize(15);
    text("(depends on your score)", 200, 200);
    textSize(20);
    ...
    textSize(30);
    text("Click the little monster to fight", width/2, 650);
    //if (keyPressed) {
    //  gameState = 0;
    //   counter = 0;
    //  score = 0;
...
void gameE1(){
  ...
  fill(0);
  textSize(60);
  text("Congratulation!Completed level 1",width/2, 300);
  textSize(30);
  text("Fight more to have other ending",width/2, 400);
  kick.trigger();
  delay(1500);
}
void gameE2(){
  ...
  fill(0);
  textSize(60);
  text("Congratulation!Completed level 2",width/2, 300);
  textSize(30);
  text("(Fight more to have final ending)",width/2, 400);
  kick.trigger();
  delay(1500);
}
